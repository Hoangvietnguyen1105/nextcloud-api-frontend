  ...
  var e = {
            ...
            for (var n in e) {
              ...
              void 0 !== t &&
                ("number" == typeof i || "string" == typeof i
                  ? (t[n] = i)
                  : Array.isArray(i) && (t[n] = JSON.parse(JSON.stringify(i))));
            }
          }
          !(function () {
            var n,
                  ...
                  P = function (i) {
                    var a = (function (i) {
                      ...
                      if (null == n) {
                        ...
                        1 === l.versions.timings && t(c, l.timings),
                          t(u, l.memory);
                      } else O(l);
                      return (
                        (l.firstPaint = _("first-paint")),
                        (l.firstContentfulPaint = _("first-contentful-paint")),
                        p &&
              ...
              switch (
                ...
                case "LCP":
                  (c = e.attribution) &&
                    ...
                    (E.lcp.it =
                      null === (r = c.lcpResourceEntry) || void 0 === r
                        ? void 0
                        : r.initiatorType),
                    (E.lcp.fp =
                      null ===
              ...
              if ("function" == typeof s.getEntriesByType) {
                ...
                (e.timingsV2 = {}),
                  n &&
                    n[0] &&
                    (n[0].nextHopProtocol &&
                      (i.nextHopProtocol = n[0].nextHopProtocol),
      ...
      752: function (e, t) {
        ...
        (t.__esModule = !0),
          ...
          (t.sendObjectBeacon = function (e, t, n, i, r) {
      ...
      699: function (e, t) {
        ...
        (t.__esModule = !0),
          ...
          ((i = t.EventType || (t.EventType = {}))[(i.Load = 1)] = "Load"),
          (i[(i.Additional = 2)] = "Additional"),
          (i[(i.WebVitalsV2 = 3)] = "WebVitalsV2"),
                      ...
                      e.forEach(function (e) {
                        "first-contentful-paint" === e.name &&
                          ...
                          e.startTime < i.firstHiddenTime &&
                            ((r.value = Math.max(e.startTime - v(), 0)),
                            r.entries.push(e),
                            n(!0)));
                      });
                    });
                  o &&
                    ((n = g(e, r, B, t.reportAllChanges)),
                    d(function (i) {
                      (r = p("FCP")),
                        (n = g(e, r, B, t.reportAllChanges)),
                        y(function () {
                      ...
                      var n = function () {
                        ...
                        r = function () {
                          removeEventListener("pointerup", n, x),
                            removeEventListener("pointercancel", i, x);
                        };
                      addEventListener("pointerup", n, x),
                        addEventListener("pointercancel", i, x);
                    })(t, e)
                  : I(t, e);
              }
            },
              ...
              $(function () {
                ...
                if (r) {
                  ...
                  (n.value = Math.max(o - v(), 0)),
                    ...
                    d(function () {
                      (n = p("TTFB", 0)),
                        (i = g(e, n, Z, t.reportAllChanges))(!0);
                    });
                }
              });
            };
                    ...
                    var n,
                      ...
                      o = function (e) {
                        ...
                        t &&
                          ...
                          ((r.value = Math.max(t.startTime - v(), 0)),
                          (r.entries = [t]),
                          n());
                      },
                  ...
                  if (e.entries.length) {
                    ...
                    if (t) {
                      var n = t.activationStart || 0,
                        ...
                        c = Math.max(
                          o,
                          r ? (r.requestStart || r.startTime) - n : 0
                        ),
